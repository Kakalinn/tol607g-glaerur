...
\env{frame}
{
	\env{itemize}
	{
		...
		\[
			...
			\frac{n \cdot (n + 1)}{2}.
		\]
		\item<5-> Svo, þar sem $n$ getur verið allt að $10^6$, getur svarið okkar orðið of stórt fyrir \ilcode{int}.
		\item<6-> Við þurfum því að nota \ilcode{long long}.
	}
}

\env{frame}
{
	\code{code/reiknirit1.c}
}

\env{frame}
{
	\code{code/reiknirit2.c}
}
