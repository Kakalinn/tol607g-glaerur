...
\env{frame}
{
	...
	\env{itemize}
	{
		...
		\item<3-> \emph{Slembið reiknirit} er reiknirit sem skilar réttu svar með líkum $p$.
		\item<4-> Við getum þá keyrt reikniritið $s$ sinnum, og þá er það rétt með líkum $p^s$ (gerum ráð fyrir óhæði).
