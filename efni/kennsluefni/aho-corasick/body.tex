...
\section{Rakningarformúla fyrir bakstrengsleggi}
\env{frame}
{
    \env{itemize}
    {
...
\env{frame}
{
    \env{tikzpicture}
    {
        ...
        \onslide<all:3-> { \path[draw, thick, green, dotted] (7) edge[bend left = 90] node {} (1); }
        \onslide<all:5-> { \path[draw, thick, green, dotted] (8) edge[bend left = 90] node {} (1); }
        \onslide<all:7-> { \path[draw, thick, green, dotted] (9) edge[bend left = 90] node {} (1); }
        \onslide<all:9-> { \path[draw, thick, green, dotted] (3) -- (6); }
        \onslide<all:11-> { \path[draw, thick, green, dotted] (4) -- (7); }
        \onslide<all:13-> { \path[draw, thick, green, dotted] (5) -- (8); }
...
\section{Færslur í stöðuvélinni}
\env{frame}
{
    \env{itemize}
    {
...
\env{frame}
{
    \env{tikzpicture}
    {
        ...
        \onslide<all:6> { \node[draw, circle, fill, blue, thick, inner sep = 1.0pt] at (4, 1) {}; }
        \onslide<all:7> { \node[draw, circle, fill, blue, thick, inner sep = 1.0pt] at (3, -1) {}; }
        \onslide<all:8-11, 13, 15> { \node[draw, circle, fill, blue, thick, inner sep = 1.0pt] at (0, 0) {}; }
        \onslide<all:12, 14, 16> { \node[draw, circle, fill, blue, thick, inner sep = 1.0pt] at (1, 1) {}; }
        \onslide<all:17> { \node[draw, circle, fill, blue, thick, inner sep = 1.0pt] at (2, 1) {}; }
        \onslide<all:18> { \node[draw, circle, fill, blue, thick, inner sep = 1.0pt] at (3, 1) {}; }
        \onslide<all:19> { \node[draw, circle, fill, blue, thick, inner sep = 1.0pt] at (4, 1) {}; }
        \onslide<all:20> { \node[draw, circle, fill, blue, thick, inner sep = 1.0pt] at (3, -1) {}; }
...
\section{Hvernig vitum við hvaða bakstrengir eru lokastöður}
\env{frame}
{
    \env{itemize}
    {
