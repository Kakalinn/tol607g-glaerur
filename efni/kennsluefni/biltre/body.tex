...
\env{frame}
{
    \selectcode{code/daemi1-biltre.c}{23}{37}
}
...
\env{frame}
{
    ...
    \selectcode{code/daemi1-biltre.c}{10}{21}
}
...
{
    \frametitle{Lausn}
    \selectcode{code/daemi2-biltre.c}{11}{38}
}
...
\env{frame}
{
    \selectcode{code/daemi3-biltre-le.c}{10}{44}
}
...
\env{frame}
{
    \selectcode{code/daemi4-biltre-le.c}{9}{20}
}

\env{frame}
{
    \selectcode{code/daemi4-biltre-le.c}{22}{56}
}
...
\env{frame}
{
    \selectcode{code/daemi5-biltre-le.c}{12}{35}
}

\env{frame}
{
    \selectcode{code/daemi5-biltre-le.c}{37}{70}
}

\env{frame}
{
    \selectcode{code/daemi5-biltre-le.c}{72}{83}
}
