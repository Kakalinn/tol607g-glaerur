...
void pop(int *h)                                                                // Fjarlægir stærsta stakið.
{
...
void push(int *h, int x)                                                        // Bætir x í hrúguna.
{
...
int peek(int *h) { return h[1]; }                                               // Skilar stærsta stakinu.
int size(int *h) { return h[0]; }                                               // Skilar stærð hrúgurnar.
void init(int *h) { h[0] = 0; }                                                 // Upphafstillir tóma hrúgu.
