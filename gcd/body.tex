...
\env{frame}
{
	\env{itemize}
	{
		\item<1-> Við getum í raun tekið saman þau skref sem eiga sér stað þangað til $a > b$.
		\item<2-> Við finnum í raun $q$ þannig að $b - a \cdot n$ sé jákvætt og minna en $a$.
		\item<3-> En við getum fundið þessa tölu með \onslide<4->{leifareikningi}.
		\item<4-> Við notum því $\gcd(a, b) = \gcd(r, a)$ í staðinn fyrir $\gcd(a, b) = \gcd(a, b - a)$, þar sem $r$ er leif $b$ með tilliti til $a$.
	}
}
