...
\begin{itemize}
	...
	\item<4-> Við getum bætt við staki í $\mathcal{O}(\log n)$.
	\item<5-> Forgangsbiðraðir (e. priority queue) eru oftast útfærðar með svona hrúgum og eru að finna í mörgum forritunarmálum.
\end{itemize}
\end{frame}
