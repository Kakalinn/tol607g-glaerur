...
\env{frame}
{
	\env{itemize}
	{
		\item<1-> Helmingunarleit er $\mathcal{O}($\onslide<2->{$\,n\,$}$)$, þar sem við helmingum stærð listans í hverri ítrun.
...
\env{frame}
{
	...
	\env{center}
	{
		\env{tikzpicture}
		{
			...
			\node<1-2>[below] at (0.7,-0.125) {$a$};
			\draw<1-2> (0.7,0.125) -- (0.7,-0.125);
			\draw<1-2>[dashed, gray] (0.7,0.125) -- (0.7, 4.2);
			\node<1-6>[below] at (3.7,-0.125) {$b$};
			\draw<1-6>(3.7,0.125) -- (3.7,-0.125);
			\draw<1-6>[dashed, gray] (3.7,0.125) -- (3.7,4.2);

			\node<2>[below] at (2.2,-0.125) {$m$};
			\draw<2-4> (2.2,0.125) -- (2.2,-0.125);
			\draw<2-4>[dashed, gray] (2.2,0.125) -- (2.2,4.2);

			\node<3-4>[below] at (2.2,-0.125) {$a$};

			\node<4>[below] at (2.95,-0.125) {$m$};
			\draw<4-> (2.95,0.125) -- (2.95,-0.125);
			\draw<4->[dashed, gray] (2.95,0.125) -- (2.95,4.2);

			\node<5->[below] at (2.95,-0.125) {$a$};

			\node<6>[below] at (3.325,-0.125) {$m$};
			\draw<6-> (3.325,0.125) -- (3.325,-0.125);
			\draw<6->[dashed, gray] (3.325,0.125) -- (3.325,4.2);

			\node<7->[below] at (3.325,-0.125) {$b$};
		}
	}
}
...
\env{frame}
{
	...
	\env{center}
	{
		\env{tikzpicture}
		{
			...
			\node<1-2>[below] at (0.7,-0.125) {$a$};
			\draw<1-2> (0.7,0.125) -- (0.7,-0.125);
			\draw<1-2>[dashed, gray] (0.7,0.125) -- (0.7, 2.2);
			\node<1-6>[below] at (3.7,-0.125) {$b$};
			\draw<1-6>(3.7,0.125) -- (3.7,-0.125);
			\draw<1-6>[dashed, gray] (3.7,0.125) -- (3.7,2.2);

			\node<2>[below] at (2.2,-0.125) {$m$};
			\draw<2-4> (2.2,0.125) -- (2.2,-0.125);
			\draw<2-4>[dashed, gray] (2.2,0.125) -- (2.2,2.2);

			\node<3-4>[below] at (2.2,-0.125) {$a$};

			\node<4>[below] at (2.95,-0.125) {$m$};
			\draw<4-> (2.95,0.125) -- (2.95,-0.125);
			\draw<4->[dashed, gray] (2.95,0.125) -- (2.95,2.2);

			\node<5->[below] at (2.95,-0.125) {$a$};

			\node<6>[below] at (3.325,-0.125) {$m$};
			\draw<6-> (3.325,0.125) -- (3.325,-0.125);
			\draw<6->[dashed, gray] (3.325,0.125) -- (3.325,2.2);
...
\env{frame}
{
	\env{itemize}
	{
		...
		\item<3-> Algengt er helmingurleit af þessum toga sé hluti af erfiðum dæmum.
	}
}
...
\env{frame}
{
	\env{center}
	{
		\begin{tikzpicture}[scale = 0.7]
			\draw[->] (-0.2,0) -- (11.2,0);
			\draw[->] (0,-0.2) -- (0,6.2);
			\draw[color = blue] plot[id=poly] function{5 - 1.2*x + 0.1*x**2} node[right] {$f(x)$};

			\node<1-2>[below] at (1,-0.125) {$a$};
			\draw<1-2> (1,0.125) -- (1,-0.125);
			\draw<1-2>[dashed, gray] (1,0.125) -- (1, 6.2);

			\node<1-4>[below] at (10,-0.125) {$b$};
			\draw<1-4>(10,0.125) -- (10,-0.125);
			\draw<1-4>[dashed, gray] (10,0.125) -- (10,6.2);

			\node<2>[below] at (4,-0.125) {$m_1$};
			\draw<2>(4,0.125) -- (4,-0.125);
			\draw<2>[dashed, gray] (4,0.125) -- (4,6.2);

			\node<2>[below] at (7,-0.125) {$m_2$};
			\draw<2>(7,0.125) -- (7,-0.125);
			\draw<2>[dashed, gray] (7,0.125) -- (7,6.2);

			\node<3-6>[below] at (4,-0.125) {$a$};
			\draw<3-6> (4,0.125) -- (4,-0.125);
			\draw<3-6>[dashed, gray] (4,0.125) -- (4, 6.2);

			\node<4>[below] at (6,-0.125) {$m_1$};
			\draw<4>(6,0.125) -- (6,-0.125);
			\draw<4>[dashed, gray] (6,0.125) -- (6,6.2);

			\node<4>[below] at (8,-0.125) {$m_2$};
			\draw<4>(8,0.125) -- (8,-0.125);
			\draw<4>[dashed, gray] (8,0.125) -- (8,6.2);

			\node<5-6>[below] at (8,-0.125) {$b$};
			\draw<5-6>(8,0.125) -- (8,-0.125);
			\draw<5-6>[dashed, gray] (8,0.125) -- (8,6.2);

			\node<6>[below] at (5.33,-0.125) {$m_1$};
			\draw<6>(5.33,0.125) -- (5.33,-0.125);
			\draw<6>[dashed, gray] (5.33,0.125) -- (5.33,6.2);

			\node<6>[below] at (6.67,-0.125) {$m_2$};
			\draw<6>(6.67,0.125) -- (6.67,-0.125);
			\draw<6>[dashed, gray] (6.67,0.125) -- (6.67,6.2);

			\node<7-8>[below] at (5.33,-0.125) {$a$};
			\draw<7-8>(5.33,0.125) -- (5.33,-0.125);
			\draw<7-8>[dashed, gray] (5.33,0.125) -- (5.33,6.2);

			\node<7-8>[below] at (6.67,-0.125) {$b$};
			\draw<7-8>(6.67,0.125) -- (6.67,-0.125);
			\draw<7-8>[dashed, gray] (6.67,0.125) -- (6.67,6.2);

			\draw<8>(5.78,0.125) -- (5.78,-0.125);
			\draw<8>[dashed, gray] (5.78,0.125) -- (5.78,6.2);

			\draw<8>(6.22,0.125) -- (6.22,-0.125);
			\draw<8>[dashed, gray] (6.22,0.125) -- (6.22,6.2);

			\node<9>[below] at (5.78,-0.125) {$a$};
			\draw<9>(5.78,0.125) -- (5.78,-0.125);
			\draw<9>[dashed, gray] (5.78,0.125) -- (5.78,6.2);

			\node<9>[below] at (6.22,-0.125) {$b$};
			\draw<9>(6.22,0.125) -- (6.22,-0.125);
			\draw<9>[dashed, gray] (6.22,0.125) -- (6.22,6.2);
		\end{tikzpicture}
	}
}
