...
\env{frame}
{
	...
	\env{itemize}
	{
		...
		\item<2->[] \selectcode{code/fjarlaegd-milli-linustrika.c}{9}{14}
	}
}
...
\env{frame}
{
	\selectcode{code/fjarlaegd-milli-linustrika.c}{16}{32}
}
...
\env{frame}
{
	\selectcode{code/fjarlaegd-milli-linustrika.c}{34}{40}
}
...
\env{frame}
{
	\selectcode{code/fjarlaegd-milli-linustrika.c}{42}{51}
}
...
\env{frame}
{
	...
	\env{itemize}
	{
		...
		\item<3->[] \selectcode{code/flatarmal-og-ummal.c}{20}{26}
	}
}
...
\env{frame}
{
	...
	\env{itemize}
	{
		...
		\item<4->[] \selectcode{code/flatarmal-og-ummal.c}{11}{18}
	}
}
...
\env{frame}
{
	\selectcode{code/punktur-i-marghyrningi.c}{11}{30}
}
...
\env{frame}
{
	\selectcode{code/kuptur-hjupur.c}{17}{47}
}
