...
\env{frame}
{
	...
	\scalebox{0.3}
	{
		\env{tikzpicture}
		{
			...
			\tkzDefPoint(-2,-4){P4}
			\tkzDefPoint(-1,-2){P5}
			\only<5->\tkzDrawSegments[dashed](A,B B,C C,A)
			\only<4->\tkzDrawPoint(P1)
			\only<4->\tkzDrawPoint(P2)
			\only<4->\tkzDrawPoint(P3)
			\only<4->\tkzDrawPoint(P4)
			\only<4->\tkzDrawPoint(P5)
			\only<4->\tkzDrawPoint(A)
			\only<4->\tkzDrawPoint(B)
			\only<4->\tkzDrawPoint(C)
		}
	}
}
...
\env{frame}
{
	...
	\scalebox{0.5}
	{
		\env{tikzpicture}
		{
			...
			\tkzDrawPoint(P10)
			\tkzDrawPoint(P11)
			\only<2->\tkzLabelPoint(P0){$0$}
			\only<3->\tkzLabelPoint(P1){$1$}
			\only<3->\tkzLabelPoint(P2){$2$}
			\only<3->\tkzLabelPoint(P3){$3$}
			\only<3->\tkzLabelPoint(P4){$4$}
			\only<3->\tkzLabelPoint(P5){$5$}
			\only<3->\tkzLabelPoint(P6){$6$}
			\only<3->\tkzLabelPoint(P7){$7$}
			\only<3->\tkzLabelPoint(P8){$8$}
			\only<3->\tkzLabelPoint(P9){$9$}
			\only<3->\tkzLabelPoint(P10){$10$}
			\only<3->\tkzLabelPoint(P11){$11$}
			\only<4->\tkzDrawSegments(P11,P0 P0,P1)
			\only<5>\tkzDrawSegments[dashed](P1,P2)
			\only<6-7>\tkzDrawSegments(P1,P2)
			\only<7>\tkzDrawSegments[dashed](P2,P3)
			\only<8>\tkzDrawSegments[dashed](P1,P3)
			\only<9-10>\tkzDrawSegments(P1,P3)
			\only<10>\tkzDrawSegments[dashed](P3,P4)
			\only<11>\tkzDrawSegments[dashed](P1,P4)
			\only<12->\tkzDrawSegments(P1,P4)
			\only<13>\tkzDrawSegments[dashed](P4,P5)
			\only<14-15>\tkzDrawSegments(P4,P5)
			\only<15>\tkzDrawSegments[dashed](P5,P6)
			\only<16>\tkzDrawSegments[dashed](P4,P6)
			\only<17->\tkzDrawSegments(P4,P6)
			\only<18>\tkzDrawSegments[dashed](P6,P7)
			\only<19->\tkzDrawSegments(P6,P7)
			\only<20>\tkzDrawSegments[dashed](P7,P8)
			\only<21-25>\tkzDrawSegments(P7,P8)
			\only<22>\tkzDrawSegments[dashed](P8,P9)
			\only<23-24>\tkzDrawSegments(P8,P9)
			\only<24>\tkzDrawSegments[dashed](P9,P10)
			\only<25>\tkzDrawSegments[dashed](P8,P10)
			\only<26>\tkzDrawSegments[dashed](P7,P10)
			\only<27-28>\tkzDrawSegments(P7,P10)
			\only<28>\tkzDrawSegments[dashed](P10,P11)
			\only<29>\tkzDrawSegments[dashed](P7,P11)
			\only<30->\tkzDrawSegments(P7,P11)
		}
	}
}
